...
Open the **Sites** page and click **Rescan folders** after adding, removing, or renaming a project. A rescan updates SQLite, managed hosts entries, nginx virtual-host files, and restarts Appytizer-managed nginx if it is already running. Then use the Dashboard or Services page to start nginx.
